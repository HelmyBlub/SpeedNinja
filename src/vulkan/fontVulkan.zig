...
pub fn charToTexCoords(char: u8, texX: *f32, texWidth: *f32) void {
    ...
    const imageCharSeperatePixels = [_]f32{ 0, 50, 88, 117, 142, 170, 198, 232, 262, 277, 307, 338, 365, 413, 445, 481, 508, 541, 569, 603, 638, 674, 711, 760, 801, 836, 873, 902, 931, 968, 1003, 1037, 1072, 1104, 1142, 1175, 1205, 1238, 1283, 1302, 1322, 1367, 1410, 1448, 1477 };
    var index: usize = 0;
    switch (char) {
        'a', 'A' => {
            index = 0;
